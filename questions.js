...
function q10() {
	document.getElementById('pvar questions = [q1, q2, q3, q4, q5, q6, q7, q8, q9, q10];
const correctans = ['correct'];
var totalscore=0;
function randQ() {
	if (questions.length == 0) {
...
function q10() {
	docicture').src = 'pics/q10.jpg';
	ans = ['correct', 'wrong1', 'wrong2', 'wrong3'];
	randA(ans);
}ument.getElementById('picture').src = 'pics/q10.jpg';
	ans = ['correct', 'wrong1', 'wrong2', 'wrong3'];
	randA(ans);
}icture').src = 'pics/q10.jpg';
	ans = ['correct', 'wrong1', 'wrong2', 'wrong3'];
	randA(ans);
}
